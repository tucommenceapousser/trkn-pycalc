...
class Calculator {
    ...
    switchMode(button) {
        ...
        const graphingInterface = document.querySelector('.graphing-interface');
        const displayContainer = document.querySelector('.display-container');
        
        if (basicGrid) basicGrid.classList.toggle('hide', mode !== 'basic');
        if (scientificGrid) scientificGrid.classList.toggle('hide', mode !== 'scientific');
        if (graphingInterface) graphingInterface.classList.toggle('hide', mode !== 'graphing');
        if (displayContainer) displayContainer.classList.toggle('hide', mode === 'graphing');
    }
